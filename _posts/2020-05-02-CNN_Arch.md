...
There is an identity shortcut added along with inception style splits. Do channel-wise separable convolutions. Residual connections are useful for optimizations and aggregated transformation are stronger representations.
